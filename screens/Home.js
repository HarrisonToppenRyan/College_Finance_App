...
const Home = () => {
    ...
    function renderHeader() {
        return (
            <View style={{ paddingHorizontal: SIZES.padding, paddingVertical: SIZES.padding, backgroundColor: COLORS.lightBlack }}>
                <View>
                    <Text style={{ color: COLORS.white, ...FONTS.h2 }}>My Expenses</Text>
                    ...
                    >
                        <Image
                            ...
                            style={{
                                width: 20,
                                height: 20,
                                tintColor: viewMode == "chart" ? COLORS.lightBlack : COLORS.darkgray,
                            }}
                        />
                    </TouchableOpacity>
                    ...
                    >
                        <Image
                            ...
                            style={{
                                width: 20,
                                height: 20,
                                tintColor: viewMode == "list" ? COLORS.lightBlack : COLORS.darkgray,
                            }}
                        />
                    </TouchableOpacity>
                </View>
    ...
    function renderIncomingExpensesTitle() {
        return (
            <View style={{ height: 80, backgroundColor: COLORS.lightBlack, padding: SIZES.padding }}>
                {/* Title */}
                <Text style={{ ...FONTS.h3, color: COLORS.yellow }}>INCOMING EXPENSES</Text>
                <Text style={{ ...FONTS.body4, color: COLORS.white }}>12 Total</Text>
            </View>
        )
    }
    ...
    function renderIncomingExpenses() {
        ...
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                >
                    <Text style={{ color: COLORS.lightBlack, ...FONTS.body3 }}>CONFIRM {item.total.toFixed(2)} USD</Text>
                </View>
            </View>
        )
                ...
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                    <View
                        style={{
                            width: 20,
                            height: 20,
                            backgroundColor: (selectedCategory && selectedCategory.name == item.name) ? COLORS.lightBlack : item.color,
                            borderRadius: 5
                        }}
                    />

                    <Text style={{ marginLeft: SIZES.base, color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.lightBlack : COLORS.primary, ...FONTS.h3 }}>{item.name}</Text>
                </View>

                {/* Expenses */}
                <View style={{ justifyContent: 'center' }}>
                    <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.lightBlack : COLORS.primary, ...FONTS.h3 }}>{item.y} USD - {item.label}</Text>
                </View>
            </TouchableOpacity>
        )
